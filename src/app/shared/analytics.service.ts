...
export class AnalyticsService {
    ...
    sendEvent(eventCategory: string, eventAction: string, eventLabel?: any, eventValue?: string, fieldsObject?: any) {
        // console.log('send event', eventCategory, eventAction, eventLabel, eventValue, fieldsObject);
        ga('send', 'event', eventCategory, eventAction, eventLabel, eventValue, fieldsObject);
    }

    sendUIEvent(eventAction: string, eventLabel?: string, eventValue?: any, fieldsObject?: any) {
        // console.log('send event', eventCategory, eventAction, eventLabel, eventValue, fieldsObject);
        ga('send', 'event', 'UI', eventAction, eventLabel, eventValue, fieldsObject);
    }

    sendTiming(timingCategory: string, timingVar: string, milliseconds: number, timingLabel?: string, fieldsObject?: any) {
